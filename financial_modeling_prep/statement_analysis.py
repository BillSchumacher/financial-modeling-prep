...
# Query params
# period (optional, str): "annual" or "quarterly". Default is "annual".
# limit (optional, int): The number of results to return. Default is 130
...
# Query params
# period (optional, str): "annual" or "quarterly". Default is "annual".
# limit (optional, int): The number of results to return. Default is 140
...
# Query params
# period (optional, str): "annual" or "quarterly". Default is "annual".
# limit (optional, int): The number of results to return. Default is 40
...
# Query params
# symbol (required, str): The company’s ticker symbol.
