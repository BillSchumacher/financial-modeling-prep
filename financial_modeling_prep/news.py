...
class News:
    ...
    def get_fmp_articles(self, page=0, size=5):
        """Get a list of the latest articles from a variety of sources, including the headline, snippet, and publication URL.
    ...
    def get_trending_social_sentiment(self, type, source):
        ...
        """
        return self.api.get(
            TRENDING_SOCIAL_SENTIMENT_ENDPOINT, {"type": type, "source": source}
        )

    def get_social_sentiment_change(self, type, source):
        ...
        """
        return self.api.get(
            SOCIAL_SENTIMENT_CHANGE_ENDPOINT, {"type": type, "source": source}
        )
