...
BALANCE_SHEET_STATEMENT_AS_REPORTED_ENDPOINT = "v3/balance-sheet-statement-as-reported/{symbol}"
...
FULL_FINANCIAL_STATEMENTS_AS_REPORTED_ENDPOINT = "v3/financial-statement-full-as-reported/{symbol}"
